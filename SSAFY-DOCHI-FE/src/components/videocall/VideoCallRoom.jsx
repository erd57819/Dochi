        ...
        <div className="w-80 bg-gradient-to-b from-amber-100 to-yellow-100 flex flex-col h-full overflow-hidden border-l-4 border-amber-600 shadow-xl">
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3 min-h-0">
              {/* 현재 음성 */}
              {currentSpeech.text && (
                <div className="bg-gradient-to-r from-amber-200 to-yellow-200 p-3 rounded-lg shadow-lg border-l-4 border-amber-500">
              ...
              {conversations.slice().reverse().map((conv) => (
                <div key={conv.id} className="bg-white bg-opacity-80 p-3 rounded-lg shadow border border-amber-200">
                  ...
                  {conv.aiSuggestion && (
                    <div className="mt-2 p-2 bg-gradient-to-r from-amber-600 to-amber-700 rounded shadow-lg border border-amber-800">
