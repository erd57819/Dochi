...
* **김도치** (팀장): Full-Stack 개발, AI 모델 통합, 프로젝트 매니징
  - AI 감정 분석 시스템 개발
  - WebRTC 화상 통화 시스템 구축
  - 전체 아키텍처 설계

* **이바늘** (부팀장): Frontend 개발, UI/UX 디자인
  - React 기반 반응형 웹 개발
  - 사용자 경험 최적화
  - 디자인 시스템 구축

* **박가시** (Backend 개발): 서버 개발, 데이터베이스 설계
  - Spring Boot REST API 개발
  - MySQL/Redis 데이터베이스 설계
  - JWT 인증 시스템 구현

* **최솔방울** (AI 개발): 머신러닝 모델 개발, 데이터 분석
  - 감정 분석 모델 훈련
  - 갈등 패턴 분석 알고리즘
  - FastAPI 서버 개발

* **정나뭇잎** (DevOps): 인프라 구축, CI/CD 파이프라인
  - Docker 컨테이너화
  - Jenkins CI/CD 구축
  - AWS 클라우드 인프라 관리

* **한들꽃** (QA/기획): 테스트, 기획, 문서화
