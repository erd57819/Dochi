...
import { useSTTEnhanced } from '../../hooks/useSTTEnhanced';
...
const VideoCallRoom = ({ userId, isHost, onEndCall }) => {
  ...
  // STT 훅 사용 (실제 방 ID 사용) - 하이브리드 방식
  const sttHook = useSTTEnhanced(actualRoomId, participantName, room);
  const {
    sttEnabled, aiMediationEnabled, coachingEnabled,
    allConversations, myCoachings, conversations,
