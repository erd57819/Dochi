            ...
            <div className="flex flex-col items-center">
              <div className="relative flex justify-center items-center w-[350px] h-[350px] sm:w-[400px] sm:h-[400px] lg:w-[440px] lg:h-[440px] flex-shrink-0">
                ...
                <button
                  onClick={handleSpin}
                  disabled={isSpinning}
                  className="absolute w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-[#bf7d2c] shadow-xl z-30 flex justify-center items-center transition-all duration-200 hover:bg-[#a66a25] hover:scale-105 active:scale-95 disabled:bg-gray-400 disabled:cursor-not-allowed disabled:scale-100"
